	...
	function changeSearchOptions() {
		...
		switch (boardSelection) {
			case "B1board":
				...
				<option id="Title" value="b1Title">자료_제목</option>
				<option id="Content" value="b1Content">자료_내용</option>
				<option id="Writer" value="b1Writer">자료_작성자</option>
				`;
				break;
			case "B2board":
				searchField.innerHTML = `
				<option id="Title" value="b2Title">자료_제목</option>
				<option id="Content" value="b2Content">자료_내용</option>
				<option id="Writer" value="b2Writer">자료_작성자</option>
				`;
				break;
			case "Playboard":
				searchField.innerHTML = `
				<option id="Title" value="pTitle">자료_제목</option>
				<option id="Content" value="pContent">자료_내용</option>
				<option id="Writer" value="pWriter">자료_작성자</option>
				`;
				break;
			default:
			break;
